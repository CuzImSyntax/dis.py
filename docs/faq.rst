...
This is a list of Frequently Asked Questions regarding using ``dis.py`` and its extension modules. Feel free to suggest a
...
Example code can be found in the `examples folder <https://github.com/CuzImSyntax/dis.py/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/CuzImSyntax/dis.py/blob/master/examples/background_task.py>`_
